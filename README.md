...
1. Put the folders onto your web-server, make sure they are writeable by the scripts.
	...
	2. Also you use anything in place of the default board, which is modified [Kareha](http://wakaba.c3.cx/s/web/wakaba_kareha), Public Domain and written in Perl by Dag Ågren/WAHa.06x36.
	3. If you keep it, don't forget to change passwords in config.
