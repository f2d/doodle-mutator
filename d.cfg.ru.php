...
$tmp_options_qk = 'Ваш ключ для входа с той же учётной записью';
...
$tmp_rooms_placeholder = 'Можно вписать сюда часть названия для отсева списка.';
...
В случае промаха описание никуда не идёт, рисунок же создаёт новую нить с копией задания.',
'Задание можно пытаться менять раз в '.(TARGET_CHANGE_TIME/60).' минут (или хоть сразу, если пустое), зайдя или обновив комнату.
Не открывайте одну и ту же комнату в нескольких вкладках, цель там всего одна и будет изменена.
