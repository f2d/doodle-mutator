...
,	'hta_write' =>	'Переписать .htaccess (автоматически происходит при каждом посещении админом главной страницы).'
,	'img2subdir' =>	'Картинки в подпапки.'
,	'users' =>	'Привести старые данные пользователей к новому виду.'
,	'logs' =>	'Привести старые журналы действий и сообщений к новому виду.'
,	'post_count' =>	'Очистить кэш счётчиков для списка комнат.'
);
$tmp_mod_pages = array(
	'logs' =>	'Журнал'
,	'files' =>	'Файлы'
