...
,	'bytes' => array(
	...
	,	'placeholder'	=> 'Перечислите рамки размера файла, напр.: > 0, < 123кб, 4м-5мб, = 67890, и т.д.'
	)
,	'width' => array(
...
,	'arch_404_pix' =>	'Переписать все архивы, заменяя ненайденные картинки заглушкой, или наоборот.'
