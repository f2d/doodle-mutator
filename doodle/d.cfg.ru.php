...
$tmp_options_input = array(
	'input' => array(
		'draw_app'		=> 'Рисование: начальный вариант рисовалки'
...
Если спустя какое-то время или после действий в комнате всё же решите выполнить задание, проверьте его кнопкой [a buttons|?] справа. Эта проверка выполняется автоматически при отправке поста.
