...
# System config
use constant ADMIN_PASS => 'CHANGE_ME';		# Admin password. For fucks's sake, change this.
#use constant NUKE_PASS => 'CHANGE_ME';
...
use constant MAX_IMAGE_WIDTH => 10240;		# Maximum width of image before rejecting
use constant MAX_IMAGE_HEIGHT => 10240;	# Maximum height of image before rejecting
use constant MAX_IMAGE_PIXELS => 100200300;	# Maximum width*height of image before rejecting
